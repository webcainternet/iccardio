...
class TinyMCE_Shortcodes {
	...
	function init() {
		if ( ( current_user_can( 'edit_posts' ) || current_user_can( 'edit_pages' ) ) && get_user_option('rich_editing') == 'true' ) {
			...
			wp_enqueue_style( 'tinymce-shortcodes', CHERRY_PLUGIN_URL.'admin/css/tinymce_shortcodes.css', false, '0.1', 'all');
		}
	}
	...
	function filter_mce_external_plugins( $plugins ) {
		$plugins['MyThemeShortcodes'] = CHERRY_PLUGIN_URL.'admin/shortcodes/editor_plugin.php';
